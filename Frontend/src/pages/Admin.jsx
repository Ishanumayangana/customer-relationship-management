...
const Admin = () => {
  ...
  const handleadmin = () => {
    const url = "http://localhost:8000/crm/create-admin"
...
useEffect(()=>{
    const url = "http://localhost:8000/crm/getadmin";
    Axios.get(url)
    .then((res)=>{
        if(res.status===200)
        {
    ...
    <div className="container-fluid d-flex">
      {showForm && (
        ...
        <div className="d-flex">
              ...
              <br /><br /><button onClick={handleadmin} type="submit"  className="btn btn-primary" style={{width: '200px', height: '40px'}}>Submitffffff</button>
