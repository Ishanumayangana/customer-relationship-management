...
callAPI() {
  //for 1st row
    fetch("http://localhost:8000/crm/a")
      ...
      //for previews
      fetch("http://localhost:8000/crm/bar")
        .then(result => result.json())
        .then(data => {
            this.setState({arr_ip: data})
            console.log(this.state.arr)
      });
      fetch("http://localhost:8000/crm/qp")
        .then(result => result.json())
        .then(data => {
      ...
      fetch("http://localhost:8000/crm/recentI")
        .then(result => result.json())
        .then(data => {
      ...
      fetch("http://localhost:8000/crm/recentQ")
        .then(result => result.json())
        .then(data => {
